      ...
      <el-form ref="form" :model="form" label-width="180px">
        ...
        <el-form-item label="选择支付方式">
          <el-radio-group v-model="form.resource" size="medium">
            <el-radio border label="支付宝" id="zfb"></el-radio>
            <el-radio border label="微信" id="wx"></el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item>
  ...
  .foot {
    ...
    form {
      ...
      #zfb {
        ...
        background-image: url("../../assets/images/pay_alipay.gif");
      ...
      #wx {
        ...
        height: 68px;
        display: inline-block;
        background-image: url("../../assets/images/pay_wechat.gif");
      }
    }
  }
}
