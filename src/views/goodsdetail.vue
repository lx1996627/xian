<template>
  <div class="goodsdetails">
      <el-row > 
  <el-col :span="12">
    <div class="grid-content bg-purple gl470">
      <img src="../assets/img/goods/goods-test1.1.jpg" style="width:100%; border:1px solid black" alt="详情页大图">
    </div>
<el-row :gutter="18" class="goods-small" >
  <div  v-for="item in src" :key="item.url">
  <el-col :span="6"><div class="grid-content bg-purple"><img :src="item.url" style="width:90%" alt="详情页大图"></div></el-col>
  </div>
</el-row>
  </el-col>
  <el-col :span="12">
    <div class="grid-content bg-purple-light gr670">
      ...
      <el-form ref="goodsdetail" :model="form" label-width="80px">
        ...
        <el-form-item >
           <el-button>立即抢购</el-button><el-button>加入购物车</el-button>
        </el-form-item>
      </el-form>
    </div>
  </el-col>
